...
namespace Enki {
Microphone::Microphone(Robot* owner, Vector micRelPos, double range, MicrophoneResponseModel micModel,
                       unsigned channels) {
    this->owner = owner;
    this->r = range;
...
FourWayMic::FourWayMic(Robot* owner, double micDist, double range, MicrophoneResponseModel micModel,
                       unsigned channels) {
    this->owner = owner;
    this->r = range;
    this->micModel = micModel;
